...
object Traincar4_State8 {
  ...
  /*@post: (res) => (res +/- 0.005)*/
  /*()*/
    def train4_state8_fixed16(s0 : Int, s1 : Int, s2 : Int, s3 : Int, s4 : Int, s5 : Int, s6 : Int, s7 : Int, s8 : Int, y0 : Int, y1 : Int, y2 : Int, y3 : Int, y4 : Int) : Int = {
    val _const0: Int = 0
    val _const1: Int = 0
    val _const2: Int = 1
    val _const3: Int = -1
  ...
  /*@post: (res) => (res +/- 0.0025)*/
  /*Abs error: -, Range: -*/
    def train4_state8_fixed16_05(s0 : Int, s1 : Int, s2 : Int, s3 : Int, s4 : Int, s5 : Int, s6 : Int, s7 : Int, s8 : Int, y0 : Int, y1 : Int, y2 : Int, y3 : Int, y4 : Int) : Long = {
    val _const0: Int = 0
    val _const1: Int = 0
    val _const2: Int = 1
    val _const3: Int = -1
    ...
    val _const14: Int = -1
    val _tmp27: Int = ((_const0 * s0) >> 13)
    val _tmp28: Int = ((_const1 * s1) >> 13)
    val _tmp29: Int = (_tmp27 + _tmp28)
    val _tmp30: Int = ((_const2 * s2) >> 13)
    val _tmp31: Int = (_tmp29 + _tmp30)
    val _tmp32: Int = ((_const3 * s3) >> 13)
    val _tmp33: Int = (_tmp31 + _tmp32)
    val _tmp34: Int = ((_const4 * s4) >> 12)
    val _tmp35: Int = (_tmp33 + _tmp34)
    val _tmp36: Int = ((_const5 * s5) >> 12)
    val _tmp37: Int = (_tmp35 + _tmp36)
    val _tmp38: Int = ((_const6 * s6) >> 12)
    val _tmp39: Int = (_tmp37 + _tmp38)
    val _tmp40: Long = ((_const7 * (s7 << 16).toLong) >> 32)
    val _tmp41: Long = (((_tmp39 << 16).toLong + (_tmp40 << 4)) >> 4)
    val _tmp42: Long = ((_const8 * (s8 << 16).toLong) >> 28)
    val _tmp43: Long = (((_tmp41 << 4) + _tmp42) >> 4)
    val _tmp44: Long = ((_const9 * (y0 << 16).toLong) >> 28)
    val _tmp45: Long = (((_tmp43 << 4) + _tmp44) >> 4)
    val _tmp46: Long = ((_const10 * (y1 << 16).toLong) >> 28)
    val _tmp47: Long = (((_tmp45 << 4) + _tmp46) >> 4)
    val _tmp48: Long = ((_const11 * (y2 << 16).toLong) >> 28)
    val _tmp49: Long = (((_tmp47 << 4) + _tmp48) >> 4)
    val _tmp50: Long = ((_const12 * (y3 << 16).toLong) >> 28)
    val _tmp51: Long = (((_tmp49 << 4) + _tmp50) >> 4)
    val _tmp52: Long = ((_const13 * (y4 << 16).toLong) >> 28)
    val _tmp53: Long = (((_tmp51 << 4) + _tmp52) >> 4)
    (_tmp53 + (_const14 << 12))
  }
  ...
  /*@post: (res) => (res +/- 0.0005)*/
  /*Abs error: -, Range: -*/
    def train4_state8_fixed16_01(s0 : Long, s1 : Long, s2 : Long, s3 : Long, s4 : Long, s5 : Long, s6 : Long, s7 : Long, s8 : Long, y0 : Long, y1 : Long, y2 : Long, y3 : Long, y4 : Long) : Long = {
    val _const0: Long = 1l
    val _const1: Long = 4l
    ...
    val _tmp67: Long = ((_const7 * s7) >> 32)
    val _tmp68: Long = (((_tmp66 << 16).toLong + (_tmp67 << 4)) >> 4)
    val _tmp69: Long = ((_const8 * s8) >> 28)
    val _tmp70: Long = (((_tmp68 << 4) + _tmp69) >> 4)
  ...
  /*@post: (res) => (res +/- 5.e-05)*/
  /*()*/
    def train4_state8_fixed16_001(s0 : Long, s1 : Long, s2 : Long, s3 : Long, s4 : Long, s5 : Long, s6 : Long, s7 : Long, s8 : Long, y0 : Long, y1 : Long, y2 : Long, y3 : Long, y4 : Long) : Long = {
    val _const0: Long = 1l
    val _const1: Long = 4l
    val _const2: Long = 33572l
    val _const3: Long = -33574l
    ...
    val _tmp94: Long = ((_const7 * s7) >> 32)
    val _tmp95: Long = ((_tmp93 + (_tmp94 << 4)) >> 4)
    val _tmp96: Long = ((_const8 * s8) >> 28)
    val _tmp97: Long = (((_tmp95 << 4) + _tmp96) >> 4)
  ...
  /*@post: (res) => (res +/- 8.e-08)*/
  /*()*/
    def train4_state8_fixed32(s0 : Long, s1 : Long, s2 : Long, s3 : Long, s4 : Long, s5 : Long, s6 : Long, s7 : Long, s8 : Long, y0 : Long, y1 : Long, y2 : Long, y3 : Long, y4 : Long) : Long = {
    val _const0: Long = 1l
    val _const1: Long = 4l
    val _const2: Long = 33572l
    val _const3: Long = -33574l
