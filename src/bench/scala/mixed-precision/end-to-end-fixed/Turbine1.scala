...
object Turbine1 {
  ...
  /*@post: (res) => (res +/- 0.0175)*/
  /*()*/
    def turbine1_fixed16_05(v : Int, w : Int, r : Int) : Long = {
    val _const0: Int = 32768
    val _const1: Int = 49152
    val _const2: Int = 32768
    val _const3: Int = 49152
    ...
    val _tmp16: Long = (((_const3 << 16).toLong - (_tmp15 << 2)) >> 2)
  ...
  /*@post: (res) => (res +/- 0.0035)*/
  /*()*/
    def turbine1_fixed16_01(v : Long, w : Long, r : Long) : Long = {
